...
# Top US States Widget

Displays the top 5 US states by visitor count in a horizontal bar list format.
...
| **Link to Full Report** | Yes (links to US States report) |
...
When no US state data is available for the selected period:
